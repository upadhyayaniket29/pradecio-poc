...
const TableOne = () => {
  return (
    <div className="border-stroke shadow-default dark:border-strokedark dark:bg-boxdark rounded-sm border bg-[var(--color-card-bg)] px-5 pt-6 pb-2.5 sm:px-7.5 xl:pb-1">
