...
const Header = (props: {
  ...
  return (
    <header className="dark:bg-boxdark sticky top-0 z-999 flex w-full shadow-md dark:drop-shadow-none">
          ...
          <form action="https://formbold.com/s/unique_form_id" method="POST">
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-transparent pr-4 pl-9 font-medium focus:outline-none xl:w-125"
              />
            </div>
          </form>
        </div>
