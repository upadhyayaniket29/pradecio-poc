    ...
    <>
      <section className="relative z-10 py-16 md:py-20 lg:py-28">
        <div className="container">
          <SectionTitle
            title="Experience Virtual Trading in Real-Time"
            paragraph="Watch how PGR's Virtual Trading App brings live market data to your fingertips, allowing you to master NSE Stocks and Derivatives without financial risk."
            center
            mb="80px"
          />
        </div>
