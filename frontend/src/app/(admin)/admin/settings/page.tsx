              ...
              <div className="p-7">
                <form action="#">
                  ...
                  <div className="flex justify-end gap-4.5">
                    ...
                    <button
                      className="bg-primary text-gray hover:bg-opacity-90 flex justify-center rounded px-6 py-2 font-medium"
                      type="submit"
                    >
                      Save
                    </button>
            ...
            <div className="border-stroke shadow-default dark:border-strokedark dark:bg-boxdark rounded-sm border bg-white">
              ...
              <div className="p-7">
                <form action="#">
                  ...
                  <div
                    id="FileUpload"
                    className="border-primary bg-gray dark:bg-meta-4 relative mb-5.5 block w-full cursor-pointer appearance-none rounded border border-dashed px-4 py-4 sm:py-7.5"
                  >
                    <input
                      type="file"
                      accept="image/*"
