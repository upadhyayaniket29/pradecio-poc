      ...
      <div className="mx-auto max-w-242.5">
        ...
        <div className="border-stroke shadow-default dark:border-strokedark dark:bg-boxdark overflow-hidden rounded-sm border bg-white">
          <div className="relative z-20 h-35 md:h-65">
            ...
            />
            <div className="xsm:bottom-4 xsm:right-4 absolute right-1 bottom-1 z-10">
              <label
                htmlFor="cover"
                className="bg-primary hover:bg-opacity-80 xsm:px-4 flex cursor-pointer items-center justify-center gap-2 rounded px-2 py-1 text-sm font-medium text-white"
              >
                <input
                  type="file"
                  name="cover"
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
              <div className="drop-shadow-2 relative">
                ...
                <label
                  htmlFor="profile"
                  className="bg-primary hover:bg-opacity-90 absolute right-0 bottom-0 flex h-8.5 w-8.5 cursor-pointer items-center justify-center rounded-full text-white sm:right-2 sm:bottom-2"
                >
                  <svg
                    className="fill-current"
                    width="14"
            ...
            <div className="mt-4">
              ...
              <div className="border-stroke shadow-1 dark:border-strokedark mx-auto mt-4.5 mb-5.5 grid max-w-94 grid-cols-3 rounded-md border py-2.5 dark:bg-[#37404F]">
