...
export const metadata: Metadata = {
  title: "Insights & Analysis | Praedico Global Research",
  description: "Stay informed with the latest market trends, insights, and financial analysis from the experts at Praedico.",
};
